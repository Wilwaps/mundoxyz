-- ================================================================
-- SISTEMA DE RIFAS - MIGRACIÓN SEGURA (EXISTING STRUCTURE)
-- ================================================================
-- Trabaja con la estructura EXACTA que ya existe

-- ================================================================
-- 1. VERIFICAR Y ADAPTAR TABLA RAFFLES EXISTENTE
-- ================================================================
DO $$
BEGIN
    ...
    IF EXISTS (SELECT FROM pg_tables WHERE tablename = 'raffles') THEN
        ...
        -- Verificar cada columna antes de agregar
        ...
        RAISE NOTICE 'Columnas adaptadas exitosamente en tabla raffles';
    END IF;
END $$;

-- ================================================================
-- 2. TABLAS NUEVAS (SI NO EXISTEN)
-- ================================================================
...
-- ================================================================
-- 6. VISTA PARA LOBBY (ADAPTADA A ESTRUCTURA EXISTENTE)
-- ================================================================
...
-- FINALIZACIÓN
-- ================================================================
-- Migración segura completada - trabaja con estructura existente
