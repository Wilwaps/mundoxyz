-- ================================================================
-- SISTEMA DE RIFAS - MIGRACIÓN CORREGIDA FINAL
-- ================================================================
-- Error encontrado: rc.ripple_id debe ser raffle_id

-- ================================================================
-- 1. COLUMNAS ADICIONALES PARA RAFFLES
-- ================================================================
DO $$
BEGIN
    IF EXISTS (SELECT FROM pg_tables WHERE tablename = 'raffles') THEN
        ...
        RAISE NOTICE 'Columnas adicionales agregadas';
    END IF;
END $$;
...
-- ================================================================
-- 4. FUNCIÓN PARA CÓDIGOS NUMÉRICOS
-- ================================================================
...
-- ================================================================
-- 6. VISTA CORREGIDA PARA LOBBY (ripple_id -> raffle_id)
-- ================================================================
...
LEFT JOIN raffle_companies rc ON r.id = rc.raffle_id  -- CORREGIDO: ripple_id -> raffle_id
LEFT JOIN raffle_numbers rn ON r.id = rn.raffle_id  -- CORREGIDO: ripple_id -> raffle_id
WHERE r.status IN ('pending', 'active', 'finished')
GROUP BY r.id, u.username, rc.company_name, rc.logo_url;

-- ================================================================
-- 7. TRIGGERS PARA TIMESTAMP
-- ================================================================
...
-- 8. COMENTARIOS
-- ================================================================
COMMENT ON TABLE raffle_companies IS 'Configuración branding empresas (+3000 fuegos)';
COMMENT ON TABLE raffle_numbers IS 'Estado números: available/reserved/purchased';
COMMENT ON TABLE raffle_purchases IS 'Historial completo compras';
...
COMMENT ON TABLE raffle_winners IS 'Ganadores y PDFs';
...
COMMENT ON VIEW raffle_lobby_view IS 'Vista optimizada lobby público (CORREGIDA)';

-- ================================================================
-- MIGRACIÓN CORREGIDA FINALIZADA
-- ================================================================
