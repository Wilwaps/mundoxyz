...
-- ============================================
-- 34. INVENTARIO - PROVEEDORES Y FACTURAS DE COMPRA
-- ============================================
...
CREATE TABLE IF NOT EXISTS purchase_invoices (
  ...
  invoice_ocr_data JSONB,
  invoice_ocr_status VARCHAR(20) DEFAULT 'pending',
  invoice_ocr_error TEXT
);
