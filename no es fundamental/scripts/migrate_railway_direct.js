/**
 * Script para aplicar migración 004 con credenciales directas de Railway
 */
...
// Credenciales de Railway (de las reglas del usuario)
const DATABASE_CONFIG = {
    host: 'trolley.proxy.rlwy.net',
    port: 28951,
    database: 'railway',
    user: 'postgres',
    password: 'jaUlzMfMxrTAXGtAWbYjTLBgJDSNxBPR',
