                ...
                <AnimatePresence>
                  {showShareMenu && (
                    <motion.div
                      ...
                      className="absolute left-0 sm:left-auto sm:right-0 top-full mt-2 w-48 max-w-[calc(100vw-3rem)] bg-black/80 backdrop-blur-md rounded-lg shadow-xl border border-white/10 overflow-hidden z-50"
                    >
                      <button
