...
async function main() {
  ...
  const sqlPath = path.resolve(__dirname, '../db/migrations/049_create_telegram_group_daily_rewards.sql');
  ...
  try {
    ...
    console.log('✅ Conectado. Ejecutando migración 049_create_telegram_group_daily_rewards.sql');
